...
rpm -q chromedriver | grep -v 94.0.4606.71 || sudo tools/retry zypper -n in --oldpackage chromedriver-93.0.4577.82-bp153.2.28.1 chromium-93.0.4577.82-bp153.2.28.1
export COVERAGE=1
