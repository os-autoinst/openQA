...
<div class="grid_5 alpha">
	<div class="grid_5 box box-shadow alpha" id="actions_box">
		...
		<div class="aligncenter">
			...
			<a href="/schedule/<?= $testname ?>?action=restart&back=details"><img src="/images/toggle.png" alt="restart" title="Restart Job"/></a>
			<a href="/schedule/<?= $testname ?>?action=cancel&back=details"><img src="/images/cancel.png" alt="stop" title="Stop Job"/></a>
		</div>
