...
subtest 'worker reservation API' => sub {
    ...
    my $t_admin = client(Test::Mojo->new('OpenQA::WebAPI'), apikey => 'ARTHURKEY01', apisecret => 'EXCALIBUR');
    my $t_non_op = client(Test::Mojo->new('OpenQA::WebAPI'), apikey => 'LANCELOTKEY01', apisecret => 'MANYPEOPLEKNOW');
    my $t_other_op
      = client(Test::Mojo->new('OpenQA::WebAPI'), apikey => 'GALAHADKEY01', apisecret => 'GALAHADSECRET01');
