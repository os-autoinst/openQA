...
# Remove test from group according to YAML template
...
is_deeply(YAML::XS::Load($get->tx->res->body), $yaml, 'Added group with references should be reflected in the database')
  || diag explain $get->tx->res->body;
