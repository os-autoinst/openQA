...
subtest 'run with default fixtures and verify database population' => sub {
    ...
    like $output, qr/openQA interactive test environment has been initialized/i, 'success header printed';
...
$schema->storage->dbh->do(qq{drop schema "$schema_name" cascade});
