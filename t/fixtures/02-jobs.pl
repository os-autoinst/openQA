[
    ...
    Jobs => {
        ...
        test_branch => undef,
        worker_id => 0,
        settings => [{ key => 'DVD', value => '1'},{ key => 'VERSION', value => 'Factory'},{ key => 'DESKTOP', value => 'kde'},{ key => 'ISO_MAXSIZE', value => '4700372992'},{ key => 'TEST', value => 'doc'},{ key => 'ISO', value => 'openSUSE-Factory-DVD-x86_64-Build0048-Media.iso'},{ key => 'QEMUCPU', value => 'qemu64'},{ key => 'FLAVOR', value => 'DVD'},{ key => 'BUILD', value => '0048'},{ key => 'DISTRI', value => 'opensuse'},{ key => 'ARCH', value => 'x86_64'},]
    },
    Jobs => {
        id => 99946,
        priority => 35,
