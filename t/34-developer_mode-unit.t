...
use OpenQA::LiveHandler::Controller::Developer;
...
subtest 'URLs for command server and livehandler' => sub {
    ...
    is(OpenQA::LiveHandler::Controller::Developer::determine_os_autoinst_web_socket_url($job),
    ...
    is(
        OpenQA::LiveHandler::Controller::Developer::determine_os_autoinst_web_socket_url($job),
