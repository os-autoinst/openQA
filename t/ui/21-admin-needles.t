...
like + (my $module_link = shift @tds)->get_text(), qr/[a1] day ago/, 'last use is right';
...
like +(shift @tds)->get_text(), qr/[a1] day ago/, 'last use is right';
...
like $driver->execute_script('return window.location.href'),
