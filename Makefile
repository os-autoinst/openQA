...
test-fullstack: node_modules
	$(MAKE) test-with-database RETRY=200 STABILITY_TEST=1 FULLSTACK=1 TIMEOUT_M=10000 PROVE_ARGS="$$HARNESS t/full-stack.t t/33-developer_mode.t"
	# https://github.com/os-autoinst/openQA/pull/6255/files
