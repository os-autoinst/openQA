export function setup_admin_user() {
  ...
  // Delegated event listener for deleting users
  $('#users').on('click', '.delete-user-btn', function (e) {
    e.preventDefault();
...
export function deleteUser(id, table) {
