function setupParentGroupOverviewAssets (group_id) {
  ...
  function updateGroupedByDefaultLinks () {
    if (window.location.hash !== getCookie(cookieProductName)) { $('#grouped_by_default').show(); } else { $('#grouped_by_default').hide(); }

    if (window.location.hash !== getCookie(cookieAllProductsName)) { $('#grouped_by_default_all').show(); } else { $('#grouped_by_default_all').hide(); }
  }
