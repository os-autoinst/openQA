...
function makeAssetsByGroup(assetStatus) {
  ...
  const assetsByGroupByQualifiedId = {};
  assets
    .sort(function (b, a) {
    ...
    .forEach(function (asset) {
      ...
      let assetGroup = assetsByGroupByQualifiedId[qualifiedGroupId];
      if (!assetGroup) {
  ...
  Object.values(parentGroups)
    ...
    .forEach(function (groupInfo) {
      ...
      if (window.isAdmin && groupId !== null && groupId !== undefined && groupInfo.group !== 'Untracked') {
        ...
        configLink.innerHTML = '<i class="fa-solid fa-wrench" title="Configure"></i>';
      ...
      const assetGroup = assetsByGroupByQualifiedId[qualifiedGroupId];
      if (assetGroup) {
