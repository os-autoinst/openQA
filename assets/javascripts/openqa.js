...
function setupForAll() {
  Array.from(document.querySelectorAll('[data-bs-toggle="popover"]')).forEach(
    e => new bootstrap.Popover(e, {html: true})
  );
  Array.from(document.querySelectorAll('[data-bs-toggle="tooltip"]')).forEach(
    e => new bootstrap.Tooltip(e, {html: true})
  );
  $.ajaxSetup({
...
function addFlash(status, text, container) {
  ...
  div.append('<button type="button" class="btn-close" data-dismiss="alert" aria-label="Close"></button>');
