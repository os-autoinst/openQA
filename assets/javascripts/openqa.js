...
window.setupForAll = setupForAll;
window.getCSRFToken = getCSRFToken;
window.fetchWithCSRF = fetchWithCSRF;
window.makeFlashElement = makeFlashElement;
window.addFlash = addFlash;
window.addUniqueFlash = addUniqueFlash;
window.toggleChildGroups = toggleChildGroups;
window.parseQueryParams = parseQueryParams;
window.updateQueryParams = updateQueryParams;
window.renderDataSize = renderDataSize;
window.alignBuildLabels = alignBuildLabels;
window.reloadPage = reloadPage;
window.makeUrlPort = makeUrlPort;
window.makeUrlAbsolute = makeUrlAbsolute;
window.makeWsUrlAbsolute = makeWsUrlAbsolute;
window.renderList = renderList;
window.showJobRestartResults = showJobRestartResults;
window.addParam = addParam;
window.forceJobRestartViaRestartLink = forceJobRestartViaRestartLink;
window.restartJob = restartJob;
window.htmlEscape = htmlEscape;
window.renderSearchResults = renderSearchResults;
window.testStateHTML = testStateHTML;
window.renderTestState = renderTestState;
window.updateTestState = updateTestState;
window.renderJobStatus = renderJobStatus;
window.renderActivityView = renderActivityView;
window.renderComments = renderComments;
window.renderRestarts = renderRestarts;
window.renderHttpUrlAsLink = renderHttpUrlAsLink;
window.getXhrError = getXhrError;
window.updateTimeago = updateTimeago;
