...
Test suites can extend existing test suites. Specify the test suite you want
to extend in the variable +EXTENDS+. All variables are inherited from the
specified test suite. Variables can be overridden in the extending test suite.
