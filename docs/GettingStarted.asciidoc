...
[horizontal]
Size limit:: Limits the size of assets.
...
NOTE: Checkout the <<UsersGuide.asciidoc#cleanup,Cleanup>> section for more
details and the <<UsersGuide.asciidoc#build_tagging,Build tagging>> section for
