...
The test modules foo.pm and bar.pm will be downloaded into the root of the pool diretory where tests an assets are used by isotovideo. For this reason, to schedule them, no path is needed.
