...
== Controlling the list of log files to upload

By default openQA uploads a set of file as defined in the constant +UPLOAD_FROM_POOL+
in https://github.com/os-autoinst/openQA/blob/master/lib/OpenQA/Worker/Job.pm .
You can override this set in the test variable +AUTOINST_UPLOAD_FROM_POOL+.