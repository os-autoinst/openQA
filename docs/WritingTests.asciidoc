...
Note that the value can also be overridden by setting `OPENQA_LOAD_AVG_FILE` in the environment, such as in the systemd service or executing isotovideo directly.
