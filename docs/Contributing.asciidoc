...
file +cpanfile+ at the root of the openQA repository. Some additional
...
To use ChromeDriver instead of PhantomJS the environment variable
+SELENIUM_CHROME+ can be set.
