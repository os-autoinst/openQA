...
By default, cloning based on `CASEDIR` and `NEEDLES_DIR` and automatic needle updates
are enabled, but the other features are disabled. To control these features, you can use
