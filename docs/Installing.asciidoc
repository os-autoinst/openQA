...
For triggering new test or cloning existing one you can use `openqa-cli` which
...
From there, you can trigger a new job or clone existing one, e.g.:
...
openqa-clone-job openqa-clone-job https://openqa.opensuse.org/tests/1896520
----
