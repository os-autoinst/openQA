...
# The following line is generated from dependencies.yaml
%define devel_no_selenium_requires %build_requires %cover_requires %qemu %style_check_requires %test_requires curl make perl(Perl::Tidy) perl(Test::CheckGitStatus) postgresql-devel python3-typer rsync sudo tar xorg-x11-fonts
# The following line is generated from dependencies.yaml
