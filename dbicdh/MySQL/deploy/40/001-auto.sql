...
-- Created on Wed Jul 13 16:48:29 2016
-- 
;
...
CREATE TABLE `job_modules` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `job_modules_fk_job_id` FOREIGN KEY (`job_id`) REFERENCES `jobs` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB;
--
-- Table: `job_settings`
--
...
CREATE TABLE `job_module_needles` (
  ...
  CONSTRAINT `job_module_needles_fk_job_module_id` FOREIGN KEY (`job_module_id`) REFERENCES `job_modules` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
