...
;
INSERT INTO jobs_temp_alter( id, slug, result_dir, state, priority, result, clone_id, retry_avbl, backend, backend_info, group_id, t_started, t_finished, t_created, t_updated) SELECT id, slug, result_dir, state, priority, result, clone_id, retry_avbl, backend, backend_info, group_id, t_started, t_finished, t_created, t_updated FROM jobs;
...
;
INSERT INTO jobs SELECT id, slug, result_dir, state, priority, result, clone_id, retry_avbl, backend, backend_info, group_id, t_started, t_finished, t_created, t_updated FROM jobs_temp_alter;
