...
sub startup ($self) {
    ...
    $api_ro->post('/workers/<workerid>/reservation')->name('apiv1_worker_reserve')->to('worker#reserve');
    $api_ro->delete('/workers/<workerid>/reservation')->name('apiv1_worker_release')->to('worker#release');
